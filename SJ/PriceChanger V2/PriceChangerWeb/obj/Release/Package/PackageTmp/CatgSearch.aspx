<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatgSearch.aspx.cs" Inherits="PriceChangerWeb.CatgSearch" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="margin-top: 30px;"><center><h3>Product Editor - Search for products | <asp:Label ID="lblWelcome" runat="server" Text=""></asp:Label>  | <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="LandingMenu.aspx">Home</asp:LinkButton> </h3>
            </center>
          </div>
    <div>
       <div style="margin-top: 30px;" >
        ...
        <asp:Button ID="btnAddCatagory" runat="server" Text="Search" OnClick="btnAddCatagory_Click" Visible="False" />
               </center>    </td>
                   <td>&nbsp;</td>
               </tr>
               <tr>
