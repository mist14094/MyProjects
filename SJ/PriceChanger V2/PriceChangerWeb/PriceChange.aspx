<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriceChange.aspx.cs" Inherits="PriceChangerWeb.PriceChange" %>
...
<body style="background-color: #f7f7e9; font-family:Arial,sans-serif ">
  ...
  <asp:Label ID="lblUPC" runat="server" Text=""></asp:Label>
        ...
        <wijmo:C1ComboBox ID="C1ComboBox1" runat="server" DropdownWidth="900" MinLength="40"  Width="100%" ></wijmo:C1ComboBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
