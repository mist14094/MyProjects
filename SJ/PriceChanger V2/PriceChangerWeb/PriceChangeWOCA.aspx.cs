...
{
    public partial class PriceChangeWOCA : System.Web.UI.Page
    {
        ...
        protected void btnSaveValue_Click(object sender, EventArgs e)
        {
            ...
            if (products != null && products.Count > 0)
            {
                ...
                {
                    var newprice =
                        bl.UpdatePriceWOCategory(product.UPC, product.SKU, product.StoreID, product.Price,
                           Convert.ToDecimal(GetTextValue("txtPriceStore", product.StoreID.ToString(CultureInfo.InvariantCulture))),
                            ...
                            GetTextValue("txtDescStore", product.StoreID.ToString(CultureInfo.InvariantCulture)),1);
                }
