<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WReceiveTruck.aspx.cs" Inherits="GasBlenderWeb.WReceiveTruck" %>
...
&nbsp;</td>
        ...
        <tr>
            <td>Override Add amt:<br />
&nbsp;</td>
            <td>&nbsp;</td>
            <td class="ac">
                <asp:CheckBox ID="chkOverride1" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkOverride2" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkOverride3" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkOverride4" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkOverride5" runat="server" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td>Combine Cmpnts<br />
&nbsp;</td>
            <td>&nbsp;</td>
            <td class="ac">
                <asp:CheckBox ID="chkCombine1" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkCombine2" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkCombine3" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkCombine4" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkCombine5" runat="server" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td>Use Compartment<br />
&nbsp;</td>
            <td>&nbsp;</td>
            <td class="ac">
                <asp:CheckBox ID="chkCompartment1" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkCompartment2" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkCompartment3" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkCompartment4" runat="server" />
            </td>
            <td class="ac">
                <asp:CheckBox ID="chkCompartment5" runat="server" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td class="ac"><asp:Button ID="btnSave" runat="server" Text="Save"  Height="25px" Width="60px"/></td>
