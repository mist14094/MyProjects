<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="True" CodeBehind="SetupTractor.aspx.cs" Inherits="GasBlenderWeb.SetupTractor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Button ID="btnAdd" runat="server" Text="Add New Tractor" OnClick="Add" CssClass="buttons" Style="margin-left: 30px; margin-top: 10px;" />
            <asp:GridView ID="GridView1" runat="server" Width="90%" Style="margin: 30px;" Height="500px" Font-Size="12px"
                ...
                <Columns>
                    <asp:BoundField DataField="TractorID" HeaderText="Tractor ID" HtmlEncode="False" />
                        ...
                        <div style="text-align: left; vertical-align: central;">
                            <table class="auto-style2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblTractorID" runat="server" Text="Tractor ID"></asp:Label>
            ...
            <asp:Panel ID="pnlAdd" runat="server" CssClass="modalPopup" Style="display: none">
                ...
                <div>
                    ...
                    <div class="body">
                        <div style="text-align: left; vertical-align: central;">
                            <center> <asp:Label runat="server" ID="lblAddTractorID" ></asp:Label></center>
                            <table class="auto-style2">
