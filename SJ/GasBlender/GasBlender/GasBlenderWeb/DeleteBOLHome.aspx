<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DeleteBOLHome.aspx.cs" Inherits="GasBlenderWeb.DeleteBOLHome" %>
            ...
            <td>
                ...
                HeaderStyle-BackColor="green" CellPadding="4" ForeColor="#333333">
                     <Columns>
                         ...
                         <asp:BoundField DataField="refNum" HeaderText="Reference#" HtmlEncode="False" />
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEdit" runat="server" Text="Delete"  OnClick="Delete" ForeColor="Blue" OnClientClick="return confirm('Are you sure want to DELETE ? ')">Delete</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                ...
                <asp:Label runat="server" ID="lblBOLMess" Text=""></asp:Label>
            </td> 
            <td>&nbsp;</td>
        </tr>
    </table>
