...
{
    public partial class ReceiveTruck_old : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string strLoadID = "";
             DataTable dt = new DataTable(); /*  = _businessAccess.ReceiveTruckLoad(ddlCarrier.SelectedValue, txtRefNo.Text,
