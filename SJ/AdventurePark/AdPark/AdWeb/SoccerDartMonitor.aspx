<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoccerDartMonitor.aspx.cs" Inherits="AdWeb.SoccerDartMonitor" %>
...
<body>
    ...
    <div class="content">
      ...
      <div class="container" >
        ...
        <div>
         <b> <h1 style="color: red; font-style: normal; text-decoration: underline; font-weight: bolder;">Soccer Darts</h1></b>  
     ...
     <br/><br/>
                    <asp:GridView   class="table table-striped table-hover" style="color: black; font-size: 120%" ID="grdMonitor" runat="server" OnRowDataBound="grdMonitor_RowDataBound" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <asp:BoundField DataField="SoccerDarts" HeaderText="Purchased Time" />
