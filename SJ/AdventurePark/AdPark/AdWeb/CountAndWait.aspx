<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="CountAndWait.aspx.cs" Inherits="AdWeb.CountAndWait" EnableEventValidation="true" %>
                    ...
                    <div class="row">
                       ...
                       <center>   <div><label class="control-label">Select the Mode</label>
                                    <asp:RadioButtonList ID="rblInandOut" runat="server" RepeatDirection="Horizontal" CellPadding="10"  >
                                        <asp:ListItem class="radio-inline">Read Tag </asp:ListItem>
                                        <asp:ListItem class="radio-inline">Read Value </asp:ListItem>
                                    </asp:RadioButtonList>
