<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Copy of BarCharts.aspx.cs" Inherits="BarCharts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <hr />
         ...
         <div>
             <hr />
             <shield:ShieldChart ID="ShieldChart1" runat="server"></shield:ShieldChart>
         </div>
    </div>
</asp:Content>
