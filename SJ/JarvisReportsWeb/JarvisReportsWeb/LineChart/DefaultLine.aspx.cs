    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            var chartAxisX = new ChartAxisX
            {
                ...
                AxisTickText = { TextAngle = 0, Y = 20,Step =0 },
                Title = { Text = "X Axis" }
            ...
            var chartAxisY = new ChartAxisY
            {
                TicksRepeat = 0,
                SwapLocation = false,
                AxisTickText = { TextAngle = 0, Y = 0, Step = 0 },
                Title = { Text = "Y Axis" }
            };
            ...
            chartlineseries.Settings.PointMark.ActiveSettings.PointSelectedState.DrawWidth = 40;
            chartlineseries.Settings.PointMark.ActiveSettings.PointSelectedState.DrawRadius = 40;
