...
namespace LotControlDataAccess
{
    public class LcDataAccess
    {
        ...
        public DataTable GetJobDetails(string jobNumber)
        {
            ...
            var selectCommand = new SqlCommand
            {
                CommandText = string.Format(_constants.GetJobDetails)
                ,
                CommandTimeout = 180,
                CommandType = CommandType.StoredProcedure
            };

            selectCommand.Parameters.Add("@JobNumber", jobNumber);
            var adapter = new SqlDataAdapter(selectCommand);
            var connection = new SqlConnection(_constants.FactoryLotControlString);
            selectCommand.Connection = connection;
            try
        ...
        public DataTable GetJobMasterDetails(string jobNumber)
        {
            ...
            var selectCommand = new SqlCommand
            {
                CommandText = string.Format(_constants.GetJobMasterDetails, jobNumber)
                ,
                CommandTimeout = 180,
                CommandType = CommandType.Text
            };
