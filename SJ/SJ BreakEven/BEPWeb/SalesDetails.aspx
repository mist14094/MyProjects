<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SalesDetails.aspx.cs" Inherits="BEPWeb.SalesDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="printableArea">
        ...
        <table>
            ...
            <tr>
                <asp:GridView ID="gv_SalesDetail" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="RetailPrice" HeaderText="Retail Price" SortExpression="RetailPrice"
                            DataFormatString="{0:F2}">
                            <ItemStyle Width="5%" CssClass="GridViewItemStyle" />
                        </asp:BoundField>
                        <asp:BoundField DataField="QtySold" HeaderText="Quantity Sold" SortExpression="QtySold">
                            <ItemStyle Width="5%" CssClass="GridViewItemStyle" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TotalPrice" HeaderText="Total Price" DataFormatString="{0:F2}">
                            <ItemStyle Width="5%" CssClass="GridViewItemStyle" />
                        </asp:BoundField>
                        <asp:BoundField DataField="SaleTime" HeaderText="Sale Time" DataFormatString="{0:d}"
                            SortExpression="SaleTime">
                            <ItemStyle Width="10%" CssClass="GridViewItemStyle" />
                        </asp:BoundField>
                        <asp:BoundField DataField="RefSystem" HeaderText="Source" SortExpression="RefSystem">
                            <ItemStyle Width="5%" CssClass="GridViewItemStyle" />
                        </asp:BoundField>
                        <asp:BoundField DataField="RefReceiptNumber" HeaderText="Receipt #" SortExpression="RefReceiptNumber">
                            <ItemStyle Width="8%" CssClass="GridViewItemStyle" />
                        </asp:BoundField>
                    </Columns>
