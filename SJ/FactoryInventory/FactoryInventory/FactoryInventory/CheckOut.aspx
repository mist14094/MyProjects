<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CheckOut.aspx.cs" Inherits="FactoryInventory.CheckOut" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:TextBox placeholder="Scan the Shelf" ID="TextBox1" runat="server" TextMode="SingleLine" TabIndex="1" Height="112px" Width="100%" AutoPostBack="True" autofocus="autofocus"></asp:TextBox>
        <br />
        <br />
        <br />
