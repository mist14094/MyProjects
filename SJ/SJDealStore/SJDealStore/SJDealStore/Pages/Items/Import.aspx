...
<div id="dvScroll" >
     ...
     <asp:FileUpload id="FileUploadControl" runat="server" Width="50%"/>
                                <br />
                                Catagory Name to Square
                                <br />
                                <asp:TextBox ID="txtCategoryName" runat="server" Width="25%"></asp:TextBox>
                                  <asp:RequiredFieldValidator Display="Dynamic" ID="rfValidator" runat="server" ErrorMessage="Category Required" ControlToValidate="txtCategoryName"></asp:RequiredFieldValidator>
    ...
    <asp:Label runat="server" id="StatusLabel" text="Upload status: " />
                                <br />
        <br />
        <asp:GridView ID="gdViewExcelValues" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
    ...
    <br />
                                <br />
                                <br />
                                Download Template <a href="../Templ.xlsx">Templ.xlsx</a><br />
    </div>
