<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchStringPrintJS.aspx.cs" Inherits="SJDealStore.Pages.Items.SearchStringPrintJS" %>
                ...
                <div>
                    <div class="panel panel-primary">
                        ...
                        <br />
                            ...
                            &nbsp;
        <asp:TextBox ID="txtString" runat="server" OnTextChanged="TextBox1_TextChanged" Width="70%" onFocus="this.select()"></asp:TextBox>
                            ...
                            <table class="nav-justified">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <asp:CheckBox ID="chkNegRecvd" runat="server" Text="(-) Received" />
                                        <br />
                                        <asp:CheckBox ID="chkNegDmgd" runat="server" Text="(-) Damaged" />
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <div style="overflow: auto;" class="container-fluid">
                                <asp:GridView ID="grdResult" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="5" OnRowCommand="grdResult_RowCommand" OnRowDataBound="grdResult_RowDataBound">
                                    <Columns>
