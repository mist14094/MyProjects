...
{
    public partial class AddNewItemWithPrint : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            var result = _layer.AddItemsWithReceiving(txtUPC.Text, txtDesc.Text, double.Parse(txtMSRP.Text).ToString("C", nfi).ToString(), double.Parse(txtSJRetail.Text).ToString("C", nfi).ToString(),
              ddlFileSelect.SelectedValue,int.Parse(txtNoOfUnits.Text));
            if (result != null)
            {
