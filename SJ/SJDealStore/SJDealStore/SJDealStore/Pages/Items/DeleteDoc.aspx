<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteDoc.aspx.cs" Inherits="SJDealStore.Pages.Items.DeleteDoc" %>
            ...
            <div>
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        &nbsp;<asp:DropDownList ID="ddlFileSelect" runat="server" Width="50%" AutoPostBack="True">
                        </asp:DropDownList>
                        <br />
                        Type DELETE in the text box to Delete<br />
&nbsp;<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                        <br />
                        <asp:Button ID="btnSearch" runat="server" Text="Delete" OnClick="btnSearch_Click"/>
