...
{
    public partial class SearchStringPrint : System.Web.UI.Page
    {
        ...
        public void PrintTags(string barcode, string skulotNumber, string stockDesc, string price, string otherprice,string stockCode,  int NoOfCopies,string TestTag)
        {
            const string str = @"C:\OverStock_1.label";
            //   _dymoAddin.Open(str);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            _layer.SjDealsSaveSettings(int.Parse(ddlFileSelect.SelectedValue),  chkPrintTest.Checked,  txtPrefixPrice.Text,  txtPrefixOrgnlPrice.Text,
             ddlBarcode.SelectedValue, ddlOrginal.SelectedValue, ddlDesc.SelectedValue ,ddlPrice.SelectedValue, ddlOrginal.SelectedValue, txtCode.Text)
            ;
        }
    }
}