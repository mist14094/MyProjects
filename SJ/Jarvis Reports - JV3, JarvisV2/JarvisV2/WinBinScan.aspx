<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WinBinScan.aspx.cs" Inherits="WinBinScan" %>
...
&nbsp;<shield:ShieldChart ID="ShieldChart1" Width="100%" Height="900px" runat="server"
    CssClass="chart" >
       ...
       <div style="font-family:Segoe UI, Tahoma, Verdana, sans-serif;font-size:12px;cursor:pointer;color:#3E576F;fill:#3E576F;">
            Select WinBin &nbsp;  <asp:DropDownList ID="ddlBrand" runat="server" OnSelectedIndexChanged="ddlBrand_SelectedIndexChanged"></asp:DropDownList>
