...
public partial class CigarSales : System.Web.UI.Page
{
    private CigrteSales CigrteSales = new CigrteSales();
    private CigarMatrix CigarMatrix = new CigarMatrix();
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ddlStoreID.SelectedValue = "ALL";

            var cigarmatrix = CigarMatrix.GetCigarSalesData();

            ddlBrand.DataSource = cigarmatrix.Select(
    ...
    public DataTable GetCouponSalesDetail(int NoOfDays)
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("GetCigarStoreSalesDetail", connection);
