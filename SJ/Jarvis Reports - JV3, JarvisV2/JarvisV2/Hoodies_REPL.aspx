<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hoodies_REPL.aspx.cs" Inherits="_Hoodies_REPL" %>
...
<body>
    ...
    <div>
      ...
      <h3>  <center>Hoodies Split up - Zip and Pull Overs </center></h3>
       <h4><center>Report generated on <asp:Label runat="server" Text="" ID="lblDate"></asp:Label> </center></h4> </div>
      <div> <center> <asp:TextBox runat="server" ID="txtMin" Text="3"></asp:TextBox> &nbsp;<asp:DropDownList 
