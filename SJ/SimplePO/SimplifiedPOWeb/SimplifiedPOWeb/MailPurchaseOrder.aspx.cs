...
{
    public partial class MailPurchaseOrder : System.Web.UI.Page
    {
        SPOBL _spobl = new SPOBL();
        SPOConst _spoConst = new SPOConst();
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["AccessCode"] != null)
                {
                    ...
                    if (SNO != "Error")
                    {
                        ...
                        PONumber.Text = "PO Number : " + SNO + " (Intranet PO# : " +
                                        dt.Rows[0]["SJPONUMBER"].ToString() + ")";
            ...
            if (dt != null)
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (userlist != null)
                    {
                        ...
                        hplMailPreview.NavigateUrl = _spoConst.POPreviewURL + Request.QueryString["AccessCode"];
