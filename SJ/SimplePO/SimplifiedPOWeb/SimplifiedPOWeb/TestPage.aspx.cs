...
namespace SimplifiedPOWeb
{
    ...
    {
        SimplifiedPOBusiness.SPOBL spobl = new SPOBL();
        SimplifiedPOBusiness.PoBusiness _poBusiness = new PoBusiness();
        protected void Page_Load(object sender, EventArgs e)
        {

            Response.Write(spobl.TestMethod("Vivek"));
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            if (FileUpload1.HasFile)
            {
                ...
                DataTable dt = Import_To_Grid(FilePath, Extension, rbHDR.SelectedItem.Text);
