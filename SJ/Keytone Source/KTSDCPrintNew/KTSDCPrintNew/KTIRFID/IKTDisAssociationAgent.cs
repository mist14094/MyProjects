...
{
    public interface IKTDisAssociationAgent
    {
        #region Events
        ...
        event EventHandler<KTDisAssociationAgentItemsUpdated> ItemsUpdated;

       // event EventHandler<KTDisAssociationAgentExceptionsAndAlertsArgs> ExceptionsAndAlertsSeen;
