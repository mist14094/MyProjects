...
{
    public interface IKTLocationAgent
    {
        #region Events
        ...
        event EventHandler<KTLocationAgentItemsUpdated> ItemsUpdated;

        event EventHandler<KTLocationAgentExceptionsAndAlertsArgs> ExceptionsAndAlertsSeen;
