...
namespace KTone.DAL.KTDAGlobaApplLib
{
    ...
    public class User : DBInteractionBase
    {
        ...
        private Int32 _roleID, _roleIDOld, _userID, _dataOwnerID, _adUsersUpdated, _adUsersAdded, _storeID;
        ...
        public bool Validate()
        {
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@StoreID", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _storeID));
                ...
                if (_errorCode != (int)LLBLError.AllOk || _userID <= 0)
                {
                    ...
                    // Throw error.
                    throw new Exception("Stored Procedure 'pr_User_Validate' reported the ErrorCode: " + _errorCode);
                }
                return true;
            }
            catch (Exception ex)
