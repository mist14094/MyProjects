...
{
	/// <summary>
	/// Summary description for XFormException.
	/// </summary>
	
	#region ExceptionType for XForm
	/*public enum XFormExceptionType
	{
		SYSTEMTYPE,
		INVALID_PARAMETER,
		TEMPLATEs_NOTFOUND,
	...
	#endregion ExceptionType for XForm

	public class XFormException : Exception
	{
        private Logger m_Log = KTone.RFIDGlobal.KTLogger.KTLogManager.GetLogger();

		#region Constructors

		public XFormException(string msg) : base (msg)
		{
			m_Log.Error(msg);
		}

		public XFormException(string msg, Exception ex) : base(msg, ex)
		{		
			m_Log.Error(msg, ex);	
		}		

		public XFormException(string msgFormat, params object[] lstParam) : base(String.Format(msgFormat, lstParam))
		{			
