...
{
	/// <summary>
	/// This interface serves to process source-independent translation tables for 
	/// company prefix lookup while encoding/decoding 64-bit numbers to conform to 
	/// EPCGlobal standards.
	/// </summary>
	
	public interface ICompanyPrefixLookup
	{
		#region Methods

		string Lookup(UInt16 compPrefixIndex) ;
		bool Lookup(string companyPrefixValue, out UInt16 companyPrefixIndex);

		UInt16 Insert(string companyPrefix) ;
/*
		UInt16 Insert(string companyPrefix,bool createNew) ;
*/
