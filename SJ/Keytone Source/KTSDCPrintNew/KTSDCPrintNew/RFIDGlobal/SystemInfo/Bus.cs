namespace ROOT.CIMV2.Win32 {
    ...
    // An Early Bound class generated for the WMI class.Win32_Bus
    public class Bus : System.ComponentModel.Component {
        
        // Private property to hold the WMI namespace in which the class resides.
        private static string CreatedWmiNamespace = "root\\cimv2";
        
        // Private property to hold the name of WMI class which created this class.
        private static string CreatedClassName = "Win32_Bus";
        ...
        public Bus(string keyDeviceID) {
            this.InitializeObject(null, new System.Management.ManagementPath(Bus.ConstructPath(keyDeviceID)), null);
        }
        
        public Bus(System.Management.ManagementScope mgmtScope, string keyDeviceID) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(Bus.ConstructPath(keyDeviceID)), null);
        }
        
        public Bus(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public Bus(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public Bus(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public Bus(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public Bus(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public Bus(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsBusNumNull {
            get {
                if ((curObj["BusNum"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The BusType property indicates the type of the physical bus. This value will be o" +
            "ne of the values in the INTERFACE_TYPE enumeration defined in bus.h.\nExample: PC" +
            "IBus")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public BusTypeValues BusType {
            get {
                if ((curObj["BusType"] == null)) {
                    return ((BusTypeValues)(System.Convert.ToInt32(17)));
                }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The DeviceID property contains a unique name that identifies the bus.")]
        ...
        private bool ShouldSerializeBusNum() {
            if ((this.IsBusNumNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private static string ConstructPath(string keyDeviceID) {
            string strPath = "root\\cimv2:Win32_Bus";
        ...
        public static BusCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BusCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BusCollection GetInstances(System.String [] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BusCollection GetInstances(string condition, System.String [] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BusCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            return new BusCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BusCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BusCollection GetInstances(System.Management.ManagementScope mgmtScope, System.String [] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BusCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, System.String [] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new System.Management.ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\cimv2";
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_Bus", condition, selectedProperties));
            System.Management.EnumerationOptions enumOptions = new System.Management.EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BusCollection(ObjectSearcher.Get());
        }
        ...
        public static Bus CreateInstance() {
            ...
            return new Bus(tmpMgmtClass.CreateInstance());
        }
        ...
        public enum BusTypeValues {
            ...
            Internal_Processor = 12,
            
            Internal_Power_Bus = 13,
            
            PNP_ISA_Bus = 14,
            
            PNP_Bus = 15,
            
            Maximum_Interface_Type = 16,
        ...
        public class BusCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BusCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new Bus(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual System.Collections.IEnumerator GetEnumerator() {
                return new BusEnumerator(privColObj.GetEnumerator());
            }
            
            public class BusEnumerator : object, System.Collections.IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BusEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new Bus(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
