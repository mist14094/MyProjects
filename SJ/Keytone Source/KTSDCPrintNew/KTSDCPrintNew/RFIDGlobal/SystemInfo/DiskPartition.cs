namespace ROOT.CIMV2.Win32 {
    ...
    public class DiskPartition : System.ComponentModel.Component {
        ...
        public DiskPartition(string keyDeviceID) {
            this.InitializeObject(null, new System.Management.ManagementPath(DiskPartition.ConstructPath(keyDeviceID)), null);
        }
        
        public DiskPartition(System.Management.ManagementScope mgmtScope, string keyDeviceID) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(DiskPartition.ConstructPath(keyDeviceID)), null);
        }
        
        public DiskPartition(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public DiskPartition(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public DiskPartition(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public DiskPartition(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public DiskPartition(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public DiskPartition(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Boolean indicating that the DiskPartition is labelled as bootable. This does not " +
            "mean that an OperatingSystem is actually loaded on the partition.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The BootPartition property determines whether the partition is the active partiti" +
            "on. The operating system uses the active partition when booting from a hard disk" +
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The DeviceID property contains a string that uniquely identifies the disk drive a" +
            "nd partition from the rest of the system")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The DiskIndex property indicates the index number of the disk containing this par" +
            "tition.\nExample: 0.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The HiddenSectors property indicates the number of hidden sectors in the partitio" +
            "n.\nExample: 63")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Boolean indicating that the DiskPartition is labelled as the primary partition fo" +
            "r a ComputerSystem.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
...
Values: TRUE or FALSE. If TRUE, the partition needs to be rewritten.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The Size property indicates the total size (in bytes) of the partition.\nExample: " +
            "1059045376")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public ulong Size {
            get {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The StartingOffset property indicates the starting offset (in bytes) of the parti" +
            "tion.\nExample: 32256")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        public static DiskPartitionCollection GetInstances(System.String [] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static DiskPartitionCollection GetInstances(string condition, System.String [] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static DiskPartitionCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
        ...
        public static DiskPartitionCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static DiskPartitionCollection GetInstances(System.Management.ManagementScope mgmtScope, System.String [] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static DiskPartitionCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, System.String [] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new System.Management.ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\cimv2";
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_DiskPartition", condition, selectedProperties));
        ...
        public class DiskPartitionCollection : object, ICollection {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new DiskPartition(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class DiskPartitionEnumerator : object, System.Collections.IEnumerator {
                ...
                public virtual object Current {
                    get {
                        return new DiskPartition(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
