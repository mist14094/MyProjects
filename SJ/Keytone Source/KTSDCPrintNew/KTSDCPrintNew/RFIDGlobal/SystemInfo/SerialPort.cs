namespace ROOT.CIMV2.Win32 {
    ...
    // An Early Bound class generated for the WMI class.Win32_SerialPort
    public class SerialPort : System.ComponentModel.Component {
        ...
        private static string CreatedClassName = "Win32_SerialPort";
        ...
        public SerialPort(string keyDeviceID) {
            this.InitializeObject(null, new System.Management.ManagementPath(SerialPort.ConstructPath(keyDeviceID)), null);
        }
        
        public SerialPort(System.Management.ManagementScope mgmtScope, string keyDeviceID) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(SerialPort.ConstructPath(keyDeviceID)), null);
        }
        
        public SerialPort(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public SerialPort(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public SerialPort(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public SerialPort(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public SerialPort(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public SerialPort(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The DeviceID property contains a string uniquely identifying the serial port with" +
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsMaxBaudRateNull {
            get {
                if ((curObj["MaxBaudRate"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        public uint MaxBaudRate {
            get {
                ...
                return ((uint)(curObj["MaxBaudRate"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsMaximumInputBufferSizeNull {
            get {
                if ((curObj["MaximumInputBufferSize"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The MaximumInputBufferSize property specifies the maximum size of the serial port" +
            " driver\'s internal input buffer. A value of zero indicates that no maximum value" +
        ...
        public uint MaximumInputBufferSize {
            get {
                ...
                return ((uint)(curObj["MaximumInputBufferSize"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsMaximumOutputBufferSizeNull {
            get {
                if ((curObj["MaximumOutputBufferSize"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The MaximumOutputBufferSize property specifies the maximum size of the serial por" +
            "t driver\'s internal output buffer. A value of zero indicates that no maximum val" +
            "ue is imposed by the serial provider.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public uint MaximumOutputBufferSize {
            get {
                ...
                return ((uint)(curObj["MaximumOutputBufferSize"]));
            }
        }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsOSAutoDiscoveredNull {
            get {
                if ((curObj["OSAutoDiscovered"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        public bool OSAutoDiscovered {
            get {
                ...
                return ((bool)(curObj["OSAutoDiscovered"]));
            }
        }
        ...
        public string ProviderType {
            get {
                return ((string)(curObj["ProviderType"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSettableBaudRateNull {
            get {
                if ((curObj["SettableBaudRate"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SettableBaudRate property indicates whether the baud rate can be changed for " +
            "this serial port.\nValues: TRUE or FALSE. A value of TRUE indicates the baud rate" +
            " can be changed.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SettableBaudRate {
            get {
                ...
                return ((bool)(curObj["SettableBaudRate"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSettableDataBitsNull {
            get {
                if ((curObj["SettableDataBits"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SettableDataBits property indicates whether data bits can be set for this ser" +
            "ial port.\nValues: TRUE or FALSE. A value of  TRUE indicates the data bits can be" +
            " set.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SettableDataBits {
            get {
                ...
                return ((bool)(curObj["SettableDataBits"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSettableFlowControlNull {
            get {
                if ((curObj["SettableFlowControl"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SettableFlowControl property indicates whether flow control can be set for th" +
            "is serial port.\nValues: TRUE or FALSE. A value of TRUE indicates the flow contro" +
            "l can be set.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SettableFlowControl {
            get {
                ...
                return ((bool)(curObj["SettableFlowControl"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSettableParityNull {
            get {
                if ((curObj["SettableParity"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SettableParity property indicates whether parity can be set for this serial p" +
        ...
        public bool SettableParity {
            get {
                ...
                return ((bool)(curObj["SettableParity"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSettableParityCheckNull {
            get {
                if ((curObj["SettableParityCheck"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SettableParityCheck property indicates whether parity checking can be set for" +
            " this serial port (if parity checking is supported). \nValues: TRUE or FALSE. A v" +
            "alue of TRUE indicates parity checking can be set.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SettableParityCheck {
            get {
                ...
                return ((bool)(curObj["SettableParityCheck"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSettableRLSDNull {
            get {
                if ((curObj["SettableRLSD"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SettableRLSD property indicates whether RLSD can be set for this serial port " +
            "(if Received Line Signal Detect (RLSD) is supported). \nValues: TRUE or FALSE.  A" +
            " value of TRUE indicates the RLSD can be set.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SettableRLSD {
            get {
                ...
                return ((bool)(curObj["SettableRLSD"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSettableStopBitsNull {
            get {
                if ((curObj["SettableStopBits"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SettableStopBits property indicates whether stop bits can be set for this ser" +
            "ial port.\nValues: TRUE or FALSE. A value of TRUE indicates the stop bits can be " +
            "set.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SettableStopBits {
            get {
                ...
                return ((bool)(curObj["SettableStopBits"]));
            }
        }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupports16BitModeNull {
            get {
                if ((curObj["Supports16BitMode"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The Supports16BitMode property indicates whether 16-bit mode is supported on this" +
            " serial port.\nValues: TRUE or FALSE. A value of TRUE indicates 16-bit mode is su" +
            "pported.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool Supports16BitMode {
            get {
                ...
                return ((bool)(curObj["Supports16BitMode"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupportsDTRDSRNull {
            get {
                if ((curObj["SupportsDTRDSR"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SupportsDTRDSR property indicates whether Data Terminal Ready (DTR) and Data " +
            "Set Ready (DSR) signals are supported on this serial port.\nValues: TRUE or FALSE" +
            ". A value of TRUE indicates DTR and DSR signals are supported.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SupportsDTRDSR {
            get {
                ...
                return ((bool)(curObj["SupportsDTRDSR"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupportsElapsedTimeoutsNull {
            get {
                if ((curObj["SupportsElapsedTimeouts"] == null)) {
                    return true;
                }
                else {
                    return false;
...
Values: TRUE or FALSE.  A value of TRUE indicates elapsed timeouts are supported.")]
        ...
        public bool SupportsElapsedTimeouts {
            get {
                ...
                return ((bool)(curObj["SupportsElapsedTimeouts"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupportsIntTimeoutsNull {
            get {
                if ((curObj["SupportsIntTimeouts"] == null)) {
                    return true;
                }
                else {
                    return false;
...
Values: TRUE or FALSE. A value of TRUE indicates interval timeouts are supported.")]
        ...
        public bool SupportsIntTimeouts {
            get {
                ...
                return ((bool)(curObj["SupportsIntTimeouts"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupportsParityCheckNull {
            get {
                if ((curObj["SupportsParityCheck"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SupportsParityCheck property indicates whether parity checking is supported o" +
            "n this serial port.\nValues: TRUE or FALSE. A value of TRUE indicates parity chec" +
            "king is supported.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SupportsParityCheck {
            get {
                ...
                return ((bool)(curObj["SupportsParityCheck"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupportsRLSDNull {
            get {
                if ((curObj["SupportsRLSD"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SupportsRLSD property indicates whether Received Line Signal Detect (RLSD) is" +
        ...
        public bool SupportsRLSD {
            get {
                ...
                return ((bool)(curObj["SupportsRLSD"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupportsRTSCTSNull {
            get {
                if ((curObj["SupportsRTSCTS"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SupportsRTSCTS property indicates whether Ready To Send (RTS) and Clear To Se" +
            "nd (CTS) signals are supported on this serial port.\nValues: TRUE or FALSE. A val" +
            "ue of TRUE indicates RTS and CTS signals are supported.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SupportsRTSCTS {
            get {
                ...
                return ((bool)(curObj["SupportsRTSCTS"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupportsSpecialCharactersNull {
            get {
                if ((curObj["SupportsSpecialCharacters"] == null)) {
                    return true;
                }
                else {
                    return false;
...
Values: TRUE or FALSE. A value of TRUE indicates special characters are supported.")]
        ...
        public bool SupportsSpecialCharacters {
            get {
                ...
                return ((bool)(curObj["SupportsSpecialCharacters"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupportsXOnXOffNull {
            get {
                if ((curObj["SupportsXOnXOff"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SupportsXOnXOff property indicates whether XON/XOFF flow control is supported" +
            " on this serial port.\nValues: TRUE or FALSE. A value of TRUE indicates XON/XOFF " +
            "is supported.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SupportsXOnXOff {
            get {
                ...
                return ((bool)(curObj["SupportsXOnXOff"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsSupportsXOnXOffSetNull {
            get {
                if ((curObj["SupportsXOnXOffSet"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The SupportsXOnXOffSet property indicates whether the communications provider sup" +
            "ports configuration of the XON/XOFF flow control setting.\nValues: TRUE or FALSE." +
            " A value of TRUE indicates  XON/XOFF flow control setting is supported.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool SupportsXOnXOffSet {
            get {
                ...
                return ((bool)(curObj["SupportsXOnXOffSet"]));
            }
        }
        ...
        private bool ShouldSerializeBinary() {
            if ((this.IsBinaryNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private bool ShouldSerializeMaxBaudRate() {
            if ((this.IsMaxBaudRateNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeMaximumInputBufferSize() {
            if ((this.IsMaximumInputBufferSizeNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeMaximumOutputBufferSize() {
            if ((this.IsMaximumOutputBufferSizeNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private bool ShouldSerializeOSAutoDiscovered() {
            if ((this.IsOSAutoDiscoveredNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private bool ShouldSerializeSettableBaudRate() {
            if ((this.IsSettableBaudRateNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSettableDataBits() {
            if ((this.IsSettableDataBitsNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSettableFlowControl() {
            if ((this.IsSettableFlowControlNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSettableParity() {
            if ((this.IsSettableParityNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSettableParityCheck() {
            if ((this.IsSettableParityCheckNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSettableRLSD() {
            if ((this.IsSettableRLSDNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSettableStopBits() {
            if ((this.IsSettableStopBitsNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private bool ShouldSerializeSupports16BitMode() {
            if ((this.IsSupports16BitModeNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSupportsDTRDSR() {
            if ((this.IsSupportsDTRDSRNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSupportsElapsedTimeouts() {
            if ((this.IsSupportsElapsedTimeoutsNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSupportsIntTimeouts() {
            if ((this.IsSupportsIntTimeoutsNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSupportsParityCheck() {
            if ((this.IsSupportsParityCheckNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSupportsRLSD() {
            if ((this.IsSupportsRLSDNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSupportsRTSCTS() {
            if ((this.IsSupportsRTSCTSNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSupportsSpecialCharacters() {
            if ((this.IsSupportsSpecialCharactersNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSupportsXOnXOff() {
            if ((this.IsSupportsXOnXOffNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeSupportsXOnXOffSet() {
            if ((this.IsSupportsXOnXOffSetNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private static string ConstructPath(string keyDeviceID) {
            string strPath = "root\\cimv2:Win32_SerialPort";
        ...
        public static SerialPortCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static SerialPortCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static SerialPortCollection GetInstances(System.String [] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static SerialPortCollection GetInstances(string condition, System.String [] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static SerialPortCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "Win32_SerialPort";
            ...
            return new SerialPortCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static SerialPortCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static SerialPortCollection GetInstances(System.Management.ManagementScope mgmtScope, System.String [] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static SerialPortCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, System.String [] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new System.Management.ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\cimv2";
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_SerialPort", condition, selectedProperties));
            System.Management.EnumerationOptions enumOptions = new System.Management.EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new SerialPortCollection(ObjectSearcher.Get());
        }
        ...
        public static SerialPort CreateInstance() {
            ...
            return new SerialPort(tmpMgmtClass.CreateInstance());
        }
        ...
        public enum CapabilitiesValues {
            ...
            Val_16450_Compatible = 4,
            
            Val_16550_Compatible = 5,
            
            Val_16550A_Compatible = 6,
            
            Val_8251_Compatible = 160,
            
            Val_8251FIFO_Compatible = 161,
        ...
        public class SerialPortCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public SerialPortCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new SerialPort(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual System.Collections.IEnumerator GetEnumerator() {
                return new SerialPortEnumerator(privColObj.GetEnumerator());
            }
            
            public class SerialPortEnumerator : object, System.Collections.IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public SerialPortEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new SerialPort(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
