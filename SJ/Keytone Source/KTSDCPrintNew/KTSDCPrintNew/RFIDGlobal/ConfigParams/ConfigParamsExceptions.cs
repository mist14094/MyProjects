...
{
	/// <summary>
	/// Base class for all the exceptions related to config params.
	/// </summary>
	public class ConfigParamsExceptionBase :ApplicationException
	{
		public ConfigParamsExceptionBase(string exceptionMessage):base(exceptionMessage)
		{
		}
	}
	/// <summary>
	/// Used when parameter is missing from the class specific XML config file
	/// </summary>
	public class ConfigParamExceptionParamMissing : ConfigParamsExceptionBase
	{
		public ConfigParamExceptionParamMissing(string exceptionMessage):base(exceptionMessage)
		{}
	}

	/// <summary>
	/// Used when value of parameter is missing from the class specific XML config file.
	/// </summary>
	public class ConfigParamExceptionValueMissing : ConfigParamsExceptionBase
	{
		public ConfigParamExceptionValueMissing(string exceptionMessage):base(exceptionMessage)
		{}
	}
	...
	/// Used when value of parameter is missing from the class specific XML config file.
	/// </summary>
	public class ConfigParamExceptionConfigFileMissing : ConfigParamsExceptionBase
	{
		public ConfigParamExceptionConfigFileMissing(string exceptionMessage):base(exceptionMessage)
		{}
	}
}
