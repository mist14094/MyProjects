...
{
    public class LCTNHelper
    {
        public static string LCTN_HEADER = "00110110";//0x36
        public static string ASET_HEADER = "00111010";//0x3A
        public static int LCTN13_LEN = 13;
        public static int ASET13_LEN = 13;
        public static string LCTNURI = "lctn";
        public static string ASETURI = "aset";
        public static string LOCATION_REF = "00000";
        public static byte FILTER_VALUE = 0;
    }
}
